...
subplot(title="Reconstruction AT&T Facedatabase", images=E, rows=5, cols=4, sptitle="Eigenvectors", sptitles=steps, colormap=cm.gray, filename="python_pca_reconstruction.pdf")
